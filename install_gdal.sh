...
cd ${packagedir}/gdal*
export LDFLAGS="-L${installdir}/lib64"
...
# pip install gdal==$GDALVERSION --global-option=build_ext --user --global-option="-I$installdir/include"
########################################################################################################################
########################################################################################################################
...
# python setup.py build_static install --prefix=${installdir}
########################################################################################################################
########################################################################################################################
